...
const About = memo(() => (
  <article className="container prose prose-invert mt-8 lg:prose-xl prose-a:decoration-white prose-a:transition-colors">
    ...
    <p>
      {`
      I've always found space fascinating, but I feel like astronomy apps
    ...
    <p>
      ...
      with {ReduxSaga} handling side-effects. Tables use {TanStackTable}, forms
      use {ReactHookForm} & {Zod}, math rendering uses {KaTeX}, and routing is
      done by {ReactRouter}.
    </p>
    <p>
      The server uses {Node} with {Express}, written in {TypeScript}, and built
      with {Tsup}. It also uses {PostgreSQL} for storage.
    </p>
    <h2>Source Code</h2>
    <p>
